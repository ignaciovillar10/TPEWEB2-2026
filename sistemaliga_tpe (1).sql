...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-05-2026 a las 05:15:36
...
ALTER TABLE `equipos`
  ...
  ADD KEY `idx_equipo_liga` (`nombre_liga`) USING BTREE;
...
--
ALTER TABLE `equipos`
  ADD CONSTRAINT `fk_equipo_liga` FOREIGN KEY (`nombre_liga`) REFERENCES `ligas` (`nombre`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
